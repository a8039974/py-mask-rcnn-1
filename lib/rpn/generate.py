...
def imdb_proposals(net, imdb):
    ...
    for i in xrange(imdb.num_images):
        ...
        im_name = imdb.image_path_at(i)[-10:]
        _t.tic()
        ...
        scipy.io.savemat(os.path.join('output/pascal/densenet60L5B4P25C68111520-finetune/out_mat_test500k/',im_name),dict({'bbx':imdb_boxes[i]}),appendmat=True)
        if 0:
